// Package chirp describes the communication protocol.
package chirp
...
func NewSigPeerOnline(chid string, p *Peer) *Signalling {
	return &Signalling{
		Type:    SigControl,
		OpCode:  OpPeerOnline,
		Channel: chid,
...
func NewSigPeerOffline(chid string, p *Peer) *Signalling {
	return &Signalling{
		Type:    SigControl,
		OpCode:  OpPeerOffline,
		Channel: chid,
		Cid:     p.Cid,
		Sid:     p.Sid,
	}
...
func NewSigChannelJoined(chName string) *Signalling {
	return &Signalling{
		Type:    SigControl,
		OpCode:  OpChannelJoin,
		Channel: chName,
		MeshID:  Node.MeshID,
	}
}
